...
public class WechatTab extends HorizontalScrollView {
    ...
    private int tabPadding = 0; // tab 为 textview 时的padding
    private int dividerWidth = 1;
    private int mMyUnderlinePadding = 5;
    ...
    private void setTabsValue() {
        ...
        // 设置底部Tab Indicator的颜色
        setIndicatorColor(Color.parseColor("#008165"));
        // 设置选中Tab文字的颜色 (这是我自定义的一个方法)
        setSelectedTextColor(Color.parseColor("#008165"));
        // 取消点击Tab时的背景色
        setTabBackground(0);
        //横线颜色
        setUnderlineColorResource(R.color.desc);
        //未选中的文字颜色
        setTextColorResource(R.color.titlebg);
        setUnderlinePadding0();
    }
