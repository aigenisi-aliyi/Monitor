...
public class TaskinfoPresenter {
    ...
    public void submitInfo(final String data, final List<File> picPath, final List<File> videoPath, final String qixiang, final String sanlingyaoer) {
        ...
        Flowable.just(strings)
                ...
                .subscribe(new Consumer<List<File>>() {
                    ...
                    public void accept(@NonNull List<File> list) throws Exception {
                        AddSampleDetailsInfo(data,list,videoPath,qixiang,sanlingyaoer);
                    }
                });
    }

    //提交采样信息
    public void AddSampleDetailsInfo(String data, List<File> picPath,  List<File> videoPath,String qixiang, String sanlingyaoer) {
