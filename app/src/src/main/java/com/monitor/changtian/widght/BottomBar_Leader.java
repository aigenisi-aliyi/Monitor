...
public class BottomBar_Leader extends View {

    private Context context;

    public BottomBar_Leader(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    ...
    public BottomBar_Leader setContainer(int containerId) {
        this.containerId = containerId;
        return this;
    }

    public BottomBar_Leader setTitleBeforeAndAfterColor(String beforeResCode, String AfterResCode) {//支持"#333333"这种形式
        titleColorBefore = Color.parseColor(beforeResCode);
        titleColorAfter = Color.parseColor(AfterResCode);
        return this;
    }

    public BottomBar_Leader setTitleSize(int titleSizeInDp) {
        this.titleSizeInDp = titleSizeInDp;
        return this;
    }

    public BottomBar_Leader setIconWidth(int iconWidth) {
        this.iconWidth = iconWidth;
        return this;
    }

    public BottomBar_Leader setTitleIconMargin(int titleIconMargin) {
        this.titleIconMargin = titleIconMargin;
        return this;
    }

    public BottomBar_Leader setIconHeight(int iconHeight) {
        this.iconHeight = iconHeight;
        return this;
    }

    public BottomBar_Leader addItem(Class fragmentClass, String title, int iconResBefore, int iconResAfter) {
    ...
    public BottomBar_Leader setFirstChecked(int firstCheckedIndex) {//从0开始
