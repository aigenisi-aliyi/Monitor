...
public class EquipmentinfoAdapter extends BaseQuickAdapter<EquipmentDataBean, BaseViewHolder> {
    public EquipmentinfoAdapter(int layoutResId) {
        super(layoutResId);
    }
    ...
    protected void convert(BaseViewHolder helper, EquipmentDataBean item) {
        ...
        if (item.getEquipmentNumber() != null) {
            helper.setText(R.id.tv_number, item.getEquipmentNumber());
