...
public class MeteorologicalActivity extends BaseActvity {
...
//        openGPSSettings();
        ...
        meteorologicalAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                EventBus.getDefault().post(new MeteorologicalEvent("蓝牙数据", meteorologicalAdapter.getData().get(position)));
                finish();
            }
        });
    }
    ...
    public void cf_imageButton() {
        ShowDialogtitle_cancel("正在扫描...", MeteorologicalActivity.this);
        startScan();
    }
