...
public class EquipmentFragment extends BaseFragment implements SubmitView<List<DicDataBean>> {
...
//                EquipmentListInfoActivity_.intent(getActivity()).EquiName(equipmentAdapter.getData().get(position).getDataValue()).EquiptypeId(equipmentAdapter.getData().get(position).getId()+"").start();
//            }
//        });
//
//
...
//        });
    ...
    public void initData() {
        ...
        String data = "{Id:\"\",typeCode:\"equipcategory\",DataValue:\"\"}";
