...
import static com.monitor.changtian.constant.PublicConstant.Contractstatus_YIWANJIE;
import static com.monitor.changtian.constant.PublicConstant.PageNum;

@EActivity(R.layout.activity_yj)
public class YjActivity extends FinanceBaseActivity implements SubmitView<List<ProjectcontractBean>> {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                switch (view.getId()) {
                    case R.id.tv_look_info:
                        FinanceMoneyRecordActivity_.intent(YjActivity.this).projectcontractBean(financeMainAdapter.getData().get(position)).contractid(financeMainAdapter.getData().get(position).getId()).start();
                        break;
                }
    ...
    public void initData(int page) {
        String data = "{id:\"\",projectid:\"\",schemeid:\"\",querystring:\"\",contractstatus:\"" + Contractstatus_YIWANJIE + "\",sdate:\"\",edate:\"\",smoney:\"\",emoney:\"\",pagenumber:\"" + page + "\",numbers:\"" + PageNum + "\"} ";
    ...
    public void stv_true() {
        ...
        page = 1;
        String data = "{id:\"\",projectid:\"\",schemeid:\"\",querystring:\"" + querystring + "\",contractstatus:\"" + Contractstatus_YIWANJIE + "\",sdate:\"" + sdate + "\",edate:\"" + edate + "\",smoney:\"" + smoney + "\",emoney:\"" + emoney + "\",pagenumber:\"" + page + "\",numbers:\"" + PageNum + "\"} ";
        financeMainPresenter.Getprojectcontract(data);
    }
