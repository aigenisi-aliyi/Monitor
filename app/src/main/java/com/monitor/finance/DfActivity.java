...
import static com.monitor.changtian.constant.PublicConstant.Contractstatus_DAIFU;
import static com.monitor.changtian.constant.PublicConstant.PageNum;

@EActivity(R.layout.activity_df)
public class DfActivity extends FinanceBaseActivity implements
    ...
    void init() {
        ...
        financeMainAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                FinanceActivity_.intent(DfActivity.this).projectcontractBean(financeMainAdapter.getData().get(position)).start();
            }
        });
    ...
    public void initData(int page) {
        String data = "{id:\"\",projectid:\"\",schemeid:\"\",querystring:\"\",contractstatus:\"" + Contractstatus_DAIFU + "\",sdate:\"\",edate:\"\",smoney:\"\",emoney:\"\",pagenumber:\"" + page + "\",numbers:\"" + PageNum + "\"} ";
    ...
    public void stv_true() {
        ...
        page = 1;
        String data = "{id:\"\",projectid:\"\",schemeid:\"\",querystring:\"" + querystring + "\",contractstatus:\"" + Contractstatus_DAIFU + "\",sdate:\"" + sdate + "\",edate:\"" + edate + "\",smoney:\"" + smoney + "\",emoney:\"" + emoney + "\",pagenumber:\"" + page + "\",numbers:\"" + PageNum + "\"} ";
        financeMainPresenter.Getprojectcontract(data);
    }
