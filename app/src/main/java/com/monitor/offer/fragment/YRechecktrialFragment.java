...
public class YRechecktrialFragment extends BaseFragment  implements OfferView {
...
//        initData();
        ...
        firsttrialAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                 ...
                 * 查看详情
                 */
                OfferinfoActivity_.intent(getActivity()).type("2").id(firsttrialAdapter.getData().get(position).getId()).sqstatus("3,4").start();
            }
        });
    }
    ...
    public void initData() {
        ...
        String data = "{schemeid:\"\",id:\"\",sqstatus:\"3,4\"}";
