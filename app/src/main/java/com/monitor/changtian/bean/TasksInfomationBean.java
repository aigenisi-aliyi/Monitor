...
public class TasksInfomationBean implements Serializable {
    ...
    public static class PointsBean implements Serializable, IPickerViewData {
        ...
        private String isStationarySource;
        ...
        public String getIsStationarySource() {
            return isStationarySource;
        }

        public void setIsStationarySource(String isStationarySource) {
            this.isStationarySource = isStationarySource;
        }
        ...
        public static class ScenefactorsBean implements Serializable {
            ...
            // 2019年10月29日
            private String bjzs_value;
            private String xzz_value;
            public String getBjzs_value() {
                return bjzs_value;
            }

            public String getXzz_value() {
                return xzz_value;
            }

            public void setBjzs_value(String bjzs_value) {
                this.bjzs_value = bjzs_value;
            }

            public void setXzz_value(String xzz_value) {
                this.xzz_value = xzz_value;
            }

            private String xzz_value_result;

            public String getXzz_value_result() {
                return xzz_value_result;
            }

            public void setXzz_value_result(String xzz_value_result) {
                this.xzz_value_result = xzz_value_result;
            }
